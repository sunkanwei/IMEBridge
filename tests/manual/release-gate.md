...
- [ ] View3D, Node Editor, and Graph Editor: after clicking shortcut-heavy canvases, Blender shortcuts are not captured by Chinese IME.
...
- [ ] While the mouse is over shortcut-heavy canvases, IME focus/input context does not steal Blender shortcuts.
